    ...
    options: [
      {
        ...
        nextEvent: "ELIMINATION.LOYAL_PRESENT",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        nextEvent: "ELIMINATION.LOYAL_FUTURE",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        nextEvent: "ELIMINATION.BETRAY_PRESENT",
      },
    ],
  },
  {
...
He rewards your loyalty, entrusting you with one of his pet God-Eternals, and one of his strongest works of sorcery. You have been charged with hunting down any fools who would oppose him.`,
    ...
    options: [
      {
        ...
        nextEvent: "ELIMINATION.BETRAY_FUTURE",
      },
    ],
  },
  {
    mainText: `With your help, the ragtag Ravnican forces were able to force back the invading dreadhorde, but at great cost. Nicol Bolas was able to retreat through a portal, and the survivors live in fear of a second attack. Planning has begun among all the guilds on short-term reconstruction and long-term defence. Their old rivalries have been firmly set aside to build hope for the future, but nothing they do will bring back the casualties of war:`,
    id: "ELIMINATION.LOYAL_PRESENT",
    options: [
      {
        requiredSelections: [],
        optionLabel: "",
        postSelectionText: "https://scryfall.com/card/war/187/casualties-of-war\n\nThanks for playing the Ravnica Adventure League! You got the Devastated ending.",
        rewards: [],
        nextEvent: "",
      },
    ],
  ...
  {
    mainText: `With the help of the planeswalkers that rallied to your aid, you and the Ravnican forces were able to push back the invading dreadhorde. Nicol Bolas was cornered and trapped by Ugin's machinations - he's now safely confined to a prison realm for the rest of his days. Your victory was decisive enough that most of the city is still standing. The guilds have all agreed to come together and plan a planewide celebration of their victory:`,
    id: "ELIMINATION.LOYAL_FUTURE",
    options: [
      {
        requiredSelections: [],
        optionLabel: "",
        postSelectionText: "https://scryfall.com/card/war/172/planewide-celebration\n\nThanks for playing the Ravnica Adventure League! You got the Triumphant ending.",
        rewards: [],
        nextEvent: "",
      },
    ],
  ...
  {
    mainText: `The reborn Niv-Mizzet couldn't stand directly against Nicol Bolas and his invading dreadhorde, but he didn't need to. Instead, confronted by overwhelming odds, he used the power of the living guildpact to rewind Ravnica to before Bolas' invasion. As you faded away into the past, you heard his voice in your head commanding you to make better choices next time.`,
    id: "ELIMINATION.BETRAY_PRESENT",
    options: [
      {
        requiredSelections: [],
        optionLabel: "",
        postSelectionText: "https://scryfall.com/card/war/223/time-wipe\n\nThanks for playing the Ravnica Adventure League! You got the Reborn ending.",
        rewards: [],
        nextEvent: "",
      },
    ],
  ...
  {
    mainText: `With you at the tip of the spear, the invading dreadhorde was able to sweep aside the Ravnican resistance. The city you once called home is unrecognizable, with most of its inhabitants having been killed or enslaved. You're not sure what you're going to do next, but you sense that your future is no longer yours to choose freely. Nicol Bolas' Citadel now stands in the centre of the city, where the gateway plaza once stood:`,
    id: "ELIMINATION.BETRAY_FUTURE",
    options: [
      {
        requiredSelections: [],
        optionLabel: "",
        postSelectionText: "https://scryfall.com/card/war/79/bolass-citadel\n\nThanks for playing the Ravnica Adventure League! You got the Conquered ending.",
        rewards: [],
        nextEvent: "",
      },
    ],
